'use strict';
//mock test by WangXiaoLong on 2018.3.19 13:17
const qs = require('qs');
const mockjs = require('mockjs');   //导入mock.js的模块
const Random = mockjs.Random;       //导入mock.js的随机数
let tableListData = {};             // 数据持久化   保存在global的全局变量中
...
module.exports = {                  //post请求  /api/mock 是拦截的地址   方法内部接受 request response对象
